import { classToFunction, copyToClipboard, defineNodeViews } from '@ibra-kdbra/editor';
import { CodeMirrorView, language, setLanguage, viewExtensions } from '@ibra-kdbra/editor-codemirror';
